defmodule Cldr.Language.Backend do
    ...
    quote location: :keep, bind_quoted: [module: module, backend: backend, config: config] do
      defmodule Language do
        ...
        ## Example
            ...
            => #{inspect __MODULE__}.all_languages()
        ...
        def all_languages() do
          available_languages(unquote(backend).get_locale())
        end
        ...
        ## Example
            ...
            => #{inspect __MODULE__}.available_languages("en")
            ["aa", "ab", "ace", "ach", "ada", "ady", "ae", "aeb", "af", "afh", "agq", "ain",
            "ak", "akk", "akz", "ale", "aln", "alt", "am", "an", "ang", "anp", "ar",
            "ar-001", "arc", "arn", "aro", "arp", "arq", "ars", "arw", "ary", "arz", "as",
            "asa", "ase", "ast", "av", "avk", "awa", "ay", "az", "ba", "bal", "ban", "bar",
        ...
        def available_languages(locale \\ unquote(backend).get_locale())
        ...
        ## Example
            ...
            => #{inspect __MODULE__}.known_languages("en")
            %{
              "bez" => %{standard: "Bena"},
              "lo" => %{standard: "Lao"},
              "kha" => %{standard: "Khasi"},
              ...
              ...}
        """
        @spec known_languages(String.t() | LanguageTag.t()) :: %{required(Cldr.Language.styles()) => String.t()} | {:error, term()}
        def known_languages(locale \\ unquote(backend).get_locale())
        ...
        ## Example
          ...
          iex> #{inspect __MODULE__}.to_string("eo")
          {:ok, "Esperanto"}
        """
        ...
        def to_string(key, options \\ []) do
          ...
          if result == :error && Map.get(opts, :fallback, false) do
            to_string_by_locale(key, unquote(backend).default_locale(), opts)
          else
            result
          end
        end
        ...
        defp merge_locale(opts, nil), do: Map.put(opts, :locale, unquote(backend).get_locale())
